  ...
  return (
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-lg bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 text-slate-700 dark:text-slate-300">
          ...
          >
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-lg bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 text-blue-700 dark:text-blue-400">
          ...
          >
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-lg bg-gradient-to-br from-zinc-200 to-zinc-300 dark:from-zinc-700 dark:to-zinc-800 text-zinc-800 dark:text-zinc-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-lg bg-gradient-to-br from-cyan-100 to-cyan-200 dark:from-cyan-900/30 dark:to-cyan-800/30 text-cyan-700 dark:text-cyan-400">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* CTA */}
        <div className="text-center p-12 rounded-3xl bg-gradient-to-br from-slate-100 to-blue-100 dark:from-slate-900/50 dark:to-blue-900/50 border border-zinc-200 dark:border-zinc-800">
          <h3 className="text-3xl font-bold mb-4 text-zinc-900 dark:text-zinc-50">
