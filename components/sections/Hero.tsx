...
export default function Hero() {
  return (
    <section id="home" className="pt-32 pb-20 lg:pt-[12%] lg:pb-32 px-4 sm:px-6 lg:px-8 min-h-screen lg:min-h-[calc(100vh+10rem)] relative">
      {/* Animated Background Paths - Full Height */}
